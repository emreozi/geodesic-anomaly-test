"""
Second-order (curvature) correction, Theorem 3.
...
for n in ns:
    ...
    L=lam(ph,n)
    Lc=L/(1+b/(df*n))                      # Bartlett-corrected
...
ax2.plot(ns,lvl_cor,"-s",color="#55A868",ms=5,label=r"Bartlett-corrected $\Lambda^*_n$")
...
fig.tight_layout()
fig.savefig("figs/fig_curvature.pdf",bbox_inches="tight")
fig.savefig("figs/fig_curvature.png",bbox_inches="tight",dpi=150)
print("\nwrote figs/fig_curvature.pdf")

with open("results_curvature.txt","w") as f:
