"""
Bartlett correction for the COMPOSITE statistic (independence submanifold).
...
We (1) confirm the reduction, (2) fit b_comp, (3) show the Bartlett correction restores level.
"""
import numpy as np
...
fig.tight_layout(); fig.savefig("figs/fig_composite_bartlett.pdf",bbox_inches="tight")
fig.savefig("figs/fig_composite_bartlett.png",bbox_inches="tight",dpi=150)
print("\nwrote figs/fig_composite_bartlett.pdf  b_comp=%.3f"%b_use)
