...
fig.tight_layout(); fig.savefig("figs/fig_gaussian.pdf",bbox_inches="tight")
fig.savefig("figs/fig_gaussian.png",bbox_inches="tight",dpi=150)
print("\nwrote figs/fig_gaussian.pdf")
